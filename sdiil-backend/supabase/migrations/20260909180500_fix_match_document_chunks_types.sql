-- Fix data type alignment in match_document_chunks stored procedure:
-- 1. Drop existing function to allow return type update
-- 2. Explicitly cast de.sensitivity_level::text in SELECT and WHERE to guarantee type match
